        ...
        if message.text == 'help':
            ...
            for planet in self.game.planets:
                if planet[message.chat.id].name == planet_name:
                    self.game.players[message.chat.id].current_planet = planet[message.chat.id]
            ...
            for planet in self.game.planets:
                if planet[message.chat.id].name == planet_name:
                    self.game.bot.send_message(message.chat.id, planet[message.chat.id].get_info(),
                                                   parse_mode='Markdown')
                else:
            ...
            if self.game.players[message.chat.id].opened_planets:
                opened_planets = '      -' + '\n      - '.join(self.game.players[message.chat.id].opened_planets)
